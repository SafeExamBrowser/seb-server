...
public interface ClientInstructionRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-12-12T11:08:43.171+01:00", comments="Source Table: client_instruction")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-12-12T11:08:43.172+01:00", comments="Source Table: client_instruction")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="client_connection_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ClientInstructionRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, clientConnectionId, examId, type, attributes, active)
                .from(clientInstructionRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-12-12T11:08:43.172+01:00", comments="Source Table: client_instruction")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ClientInstructionRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, clientConnectionId, examId, type, attributes, active)
                .from(clientInstructionRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-12-12T11:08:43.172+01:00", comments="Source Table: client_instruction")
    default ClientInstructionRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, clientConnectionId, examId, type, attributes, active)
                .from(clientInstructionRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
