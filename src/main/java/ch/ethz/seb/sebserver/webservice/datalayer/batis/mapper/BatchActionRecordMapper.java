...
public interface BatchActionRecordMapper {
    ...
    @ConstructorArgs({
        ...
        @Arg(column="failed", javaType=String.class, jdbcType=JdbcType.VARCHAR),
    ...
    default int insertSelective(BatchActionRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(failed).toPropertyWhenPresent("failed", record::getFailed)
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<BatchActionRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, institutionId, actionType, entityType, sourceIds, successful, failed, lastUpdate, processorId)
                .from(batchActionRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-10-06T15:12:28.740+02:00", comments="Source Table: batch_action")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<BatchActionRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, institutionId, actionType, entityType, sourceIds, successful, failed, lastUpdate, processorId)
                .from(batchActionRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-10-06T15:12:28.740+02:00", comments="Source Table: batch_action")
    default BatchActionRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, institutionId, actionType, entityType, sourceIds, successful, failed, lastUpdate, processorId)
                .from(batchActionRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(BatchActionRecord record) {
        return UpdateDSL.updateWithMapper(this::update, batchActionRecord)
                ...
                .set(failed).equalTo(record::getFailed)
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(BatchActionRecord record) {
        return UpdateDSL.updateWithMapper(this::update, batchActionRecord)
                ...
                .set(failed).equalToWhenPresent(record::getFailed)
