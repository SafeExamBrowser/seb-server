...
public final class ClientNotificationRecordDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2026-03-02T15:33:13.700+01:00", comments="Source Table: client_notification")
    public static final ClientNotificationRecord clientNotificationRecord = new ClientNotificationRecord();

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2026-03-02T15:33:13.700+01:00", comments="Source field: client_notification.id")
    public static final SqlColumn<Long> id = clientNotificationRecord.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2026-03-02T15:33:13.700+01:00", comments="Source field: client_notification.client_connection_id")
    public static final SqlColumn<Long> clientConnectionId = clientNotificationRecord.clientConnectionId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2026-03-02T15:33:13.700+01:00", comments="Source field: client_notification.event_type")
    public static final SqlColumn<Integer> eventType = clientNotificationRecord.eventType;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2026-03-02T15:33:13.700+01:00", comments="Source field: client_notification.notification_type")
    public static final SqlColumn<Integer> notificationType = clientNotificationRecord.notificationType;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2026-03-02T15:33:13.700+01:00", comments="Source field: client_notification.value")
    public static final SqlColumn<Long> value = clientNotificationRecord.value;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2026-03-02T15:33:13.700+01:00", comments="Source field: client_notification.text")
