...
public interface ExamTemplateRecordMapper {
    ...
    @ConstructorArgs({
        ...
        @Arg(column="lms_integration", javaType=Integer.class, jdbcType=JdbcType.INTEGER),
        @Arg(column="client_configuration_id", javaType=Long.class, jdbcType=JdbcType.BIGINT)
    })
    ...
    default int insert(ExamTemplateRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(lmsIntegration).toProperty("lmsIntegration")
                .map(clientConfigurationId).toProperty("clientConfigurationId")
                .build()
    ...
    default int insertSelective(ExamTemplateRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(lmsIntegration).toPropertyWhenPresent("lmsIntegration", record::getLmsIntegration)
                .map(clientConfigurationId).toPropertyWhenPresent("clientConfigurationId", record::getClientConfigurationId)
                .build()
                .render(RenderingStrategy.MYBATIS3));
    }
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ExamTemplateRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, institutionId, configurationTemplateId, name, description, examType, supporter, indicatorTemplates, institutionalDefault, lmsIntegration, clientConfigurationId)
                .from(examTemplateRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-03-24T13:22:45.894+01:00", comments="Source Table: exam_template")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ExamTemplateRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, institutionId, configurationTemplateId, name, description, examType, supporter, indicatorTemplates, institutionalDefault, lmsIntegration, clientConfigurationId)
                .from(examTemplateRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-03-24T13:22:45.895+01:00", comments="Source Table: exam_template")
    default ExamTemplateRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, institutionId, configurationTemplateId, name, description, examType, supporter, indicatorTemplates, institutionalDefault, lmsIntegration, clientConfigurationId)
                .from(examTemplateRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(ExamTemplateRecord record) {
        return UpdateDSL.updateWithMapper(this::update, examTemplateRecord)
                ...
                .set(lmsIntegration).equalTo(record::getLmsIntegration)
                .set(clientConfigurationId).equalTo(record::getClientConfigurationId);
    }
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(ExamTemplateRecord record) {
        return UpdateDSL.updateWithMapper(this::update, examTemplateRecord)
                ...
                .set(lmsIntegration).equalToWhenPresent(record::getLmsIntegration)
                .set(clientConfigurationId).equalToWhenPresent(record::getClientConfigurationId);
    }
