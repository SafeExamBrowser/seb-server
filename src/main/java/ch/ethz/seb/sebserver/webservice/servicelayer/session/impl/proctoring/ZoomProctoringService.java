...
public class ZoomProctoringService implements RemoteProctoringService {
    ...
    @Override
    public Result<Boolean> testExamProctoring(ProctoringServiceSettings proctoringSettings) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Result<ProctoringRoomConnection> getProctorRoomConnection(ProctoringServiceSettings proctoringSettings, String roomName, String subject) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Result<ProctoringRoomConnection> getClientRoomConnection(ProctoringServiceSettings proctoringSettings, String connectionToken, String roomName, String subject) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Map<String, String> createJoinInstructionAttributes(ProctoringRoomConnection proctoringConnection) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Result<Void> disposeServiceRoomsForExam(Long examId, ProctoringServiceSettings proctoringSettings) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Result<NewRoom> newCollectingRoom(ProctoringServiceSettings proctoringSettings, Long roomNumber) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Result<NewRoom> newBreakOutRoom(ProctoringServiceSettings proctoringSettings, String subject) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Result<Void> disposeBreakOutRoom(ProctoringServiceSettings proctoringSettings, String roomName) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public Map<String, String> mapReconfigInstructionAttributes(Map<String, String> attributes) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Result<Void> notifyBreakOutRoomOpened(ProctoringServiceSettings proctoringSettings, RemoteProctoringRoom room) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Result<Void> notifyCollectingRoomOpened(ProctoringServiceSettings proctoringSettings, RemoteProctoringRoom room, Collection<ClientConnection> clientConnections) {
        throw new UnsupportedOperationException();
    }

    @Override
    public void clearRestTemplateCache(Long examId) {
        throw new UnsupportedOperationException();
    }
