...
public interface ExamConfigurationMapRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-01-12T11:29:24.831+01:00", comments="Source Table: exam_configuration_map")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-01-12T11:29:24.832+01:00", comments="Source Table: exam_configuration_map")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="institution_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
