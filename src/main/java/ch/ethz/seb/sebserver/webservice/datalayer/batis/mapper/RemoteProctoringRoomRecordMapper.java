...
public interface RemoteProctoringRoomRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-11-29T10:28:49.974+01:00", comments="Source Table: remote_proctoring_room")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-11-29T10:28:49.975+01:00", comments="Source Table: remote_proctoring_room")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="exam_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
