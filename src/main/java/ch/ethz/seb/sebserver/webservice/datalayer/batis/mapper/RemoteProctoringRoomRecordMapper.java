...
public interface RemoteProctoringRoomRecordMapper {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-06T15:56:14.090+02:00", comments="Source Table: remote_proctoring_room")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="exam_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<RemoteProctoringRoomRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, examId, name, size, subject, token)
                .from(remoteProctoringRoomRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-06T15:56:14.090+02:00", comments="Source Table: remote_proctoring_room")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<RemoteProctoringRoomRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, examId, name, size, subject, token)
                .from(remoteProctoringRoomRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-06T15:56:14.090+02:00", comments="Source Table: remote_proctoring_room")
    default RemoteProctoringRoomRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, examId, name, size, subject, token)
                .from(remoteProctoringRoomRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
