...
public interface ViewRecordMapper {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-04-28T09:50:10.706+02:00", comments="Source Table: view")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="name", javaType=String.class, jdbcType=JdbcType.VARCHAR),
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-04-28T09:50:10.707+02:00", comments="Source Table: view")
