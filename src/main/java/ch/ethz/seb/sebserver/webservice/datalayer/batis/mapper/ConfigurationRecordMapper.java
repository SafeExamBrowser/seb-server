...
public interface ConfigurationRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-04-15T12:53:55.690+02:00", comments="Source Table: configuration")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-04-15T12:53:55.691+02:00", comments="Source Table: configuration")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="institution_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-04-15T12:53:55.692+02:00", comments="Source Table: configuration")
