...
public final class ClientInstructionRecordDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-17T13:37:54.114+02:00", comments="Source Table: client_instruction")
    public static final ClientInstructionRecord clientInstructionRecord = new ClientInstructionRecord();

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-17T13:37:54.114+02:00", comments="Source field: client_instruction.id")
    public static final SqlColumn<Long> id = clientInstructionRecord.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-17T13:37:54.114+02:00", comments="Source field: client_instruction.exam_id")
    public static final SqlColumn<Long> examId = clientInstructionRecord.examId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-17T13:37:54.114+02:00", comments="Source field: client_instruction.connection_token")
    public static final SqlColumn<String> connectionToken = clientInstructionRecord.connectionToken;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-17T13:37:54.114+02:00", comments="Source field: client_instruction.type")
    public static final SqlColumn<String> type = clientInstructionRecord.type;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-17T13:37:54.114+02:00", comments="Source field: client_instruction.attributes")
    public static final SqlColumn<String> attributes = clientInstructionRecord.attributes;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-17T13:37:54.114+02:00", comments="Source field: client_instruction.needs_confirmation")
    public static final SqlColumn<Integer> needsConfirmation = clientInstructionRecord.needsConfirmation;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-05-17T13:37:54.115+02:00", comments="Source field: client_instruction.timestamp")
