...
public interface UserRecordMapper {
    ...
    @ConstructorArgs({
        ...
        @Arg(column="direct_login", javaType=Integer.class, jdbcType=JdbcType.INTEGER),
        @Arg(column="local_account", javaType=Integer.class, jdbcType=JdbcType.INTEGER)
    })
    ...
    default int insert(UserRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(directLogin).toProperty("directLogin")
                .map(localAccount).toProperty("localAccount")
                .build()
    ...
    default int insertSelective(UserRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(directLogin).toPropertyWhenPresent("directLogin", record::getDirectLogin)
                .map(localAccount).toPropertyWhenPresent("localAccount", record::getLocalAccount)
                .build()
                .render(RenderingStrategy.MYBATIS3));
    }
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<UserRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, institutionId, uuid, creationDate, name, surname, username, password, email, language, timezone, active, directLogin, localAccount)
                .from(userRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2024-04-18T08:15:10.167+02:00", comments="Source Table: user")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<UserRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, institutionId, uuid, creationDate, name, surname, username, password, email, language, timezone, active, directLogin, localAccount)
                .from(userRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2024-04-18T08:15:10.167+02:00", comments="Source Table: user")
    default UserRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, institutionId, uuid, creationDate, name, surname, username, password, email, language, timezone, active, directLogin, localAccount)
                .from(userRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(UserRecord record) {
        return UpdateDSL.updateWithMapper(this::update, userRecord)
                ...
                .set(directLogin).equalTo(record::getDirectLogin)
                .set(localAccount).equalTo(record::getLocalAccount);
    }
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(UserRecord record) {
        return UpdateDSL.updateWithMapper(this::update, userRecord)
                ...
                .set(directLogin).equalToWhenPresent(record::getDirectLogin)
                .set(localAccount).equalToWhenPresent(record::getLocalAccount);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2024-04-18T08:15:10.168+02:00", comments="Source Table: user")
