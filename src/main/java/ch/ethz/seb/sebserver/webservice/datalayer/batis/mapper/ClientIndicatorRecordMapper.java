...
public interface ClientIndicatorRecordMapper {
    ...
    @ConstructorArgs({
        ...
        @Arg(column="dec_value", javaType=BigDecimal.class, jdbcType=JdbcType.DECIMAL)
    })
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-12-06T16:00:09.498+01:00", comments="Source Table: client_indicator")
    default int insert(ClientIndicatorRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(decValue).toProperty("decValue")
                .build()
    ...
    default int insertSelective(ClientIndicatorRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(decValue).toPropertyWhenPresent("decValue", record::getDecValue)
                .build()
                .render(RenderingStrategy.MYBATIS3));
    }
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ClientIndicatorRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, clientConnectionId, type, value, decValue)
                .from(clientIndicatorRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-12-06T16:00:09.498+01:00", comments="Source Table: client_indicator")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ClientIndicatorRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, clientConnectionId, type, value, decValue)
                .from(clientIndicatorRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-12-06T16:00:09.498+01:00", comments="Source Table: client_indicator")
    default ClientIndicatorRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, clientConnectionId, type, value, decValue)
                .from(clientIndicatorRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(ClientIndicatorRecord record) {
        return UpdateDSL.updateWithMapper(this::update, clientIndicatorRecord)
                ...
                .set(decValue).equalTo(record::getDecValue);
    }
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(ClientIndicatorRecord record) {
        return UpdateDSL.updateWithMapper(this::update, clientIndicatorRecord)
                ...
                .set(decValue).equalToWhenPresent(record::getDecValue);
    }
