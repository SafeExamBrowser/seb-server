...
public interface InstitutionRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-09-06T08:54:24.872+02:00", comments="Source Table: institution")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-09-06T08:54:24.873+02:00", comments="Source Table: institution")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="name", javaType=String.class, jdbcType=JdbcType.VARCHAR),
