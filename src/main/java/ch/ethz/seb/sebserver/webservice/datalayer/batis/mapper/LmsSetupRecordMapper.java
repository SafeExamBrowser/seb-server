...
public interface LmsSetupRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-08-30T15:10:37.980+02:00", comments="Source Table: lms_setup")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-08-30T15:10:37.981+02:00", comments="Source Table: lms_setup")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="institution_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
