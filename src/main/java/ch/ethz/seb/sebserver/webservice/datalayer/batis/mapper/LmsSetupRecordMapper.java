...
public interface LmsSetupRecordMapper {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-09-09T12:38:17.570+02:00", comments="Source Table: lms_setup")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="institution_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-09-09T12:38:17.571+02:00", comments="Source Table: lms_setup")
