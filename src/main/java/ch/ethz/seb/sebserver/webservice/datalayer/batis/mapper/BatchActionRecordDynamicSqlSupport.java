...
public final class BatchActionRecordDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-04-04T10:34:44.474+02:00", comments="Source field: batch_action.id")
    public static final SqlColumn<Long> id = batchActionRecord.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-04-04T10:34:44.474+02:00", comments="Source field: batch_action.institution_id")
    public static final SqlColumn<Long> institutionId = batchActionRecord.institutionId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-04-04T10:34:44.474+02:00", comments="Source field: batch_action.action_type")
    public static final SqlColumn<String> actionType = batchActionRecord.actionType;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-04-04T10:34:44.474+02:00", comments="Source field: batch_action.attributes")
    public static final SqlColumn<String> attributes = batchActionRecord.attributes;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-04-04T10:34:44.474+02:00", comments="Source field: batch_action.source_ids")
    public static final SqlColumn<String> sourceIds = batchActionRecord.sourceIds;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-04-04T10:34:44.474+02:00", comments="Source field: batch_action.successful")
    public static final SqlColumn<String> successful = batchActionRecord.successful;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-04-04T10:34:44.474+02:00", comments="Source field: batch_action.last_update")
