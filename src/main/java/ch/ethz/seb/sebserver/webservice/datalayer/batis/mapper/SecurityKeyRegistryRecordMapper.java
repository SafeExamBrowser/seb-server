...
public interface SecurityKeyRegistryRecordMapper {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-11-10T11:31:35.686+01:00", comments="Source Table: seb_security_key_registry")
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<SecurityKeyRegistryRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, institutionId, type, key, tag, examId, examTemplateId)
                .from(securityKeyRegistryRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-11-10T11:31:35.686+01:00", comments="Source Table: seb_security_key_registry")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<SecurityKeyRegistryRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, institutionId, type, key, tag, examId, examTemplateId)
                .from(securityKeyRegistryRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2022-11-10T11:31:35.686+01:00", comments="Source Table: seb_security_key_registry")
    default SecurityKeyRegistryRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, institutionId, type, key, tag, examId, examTemplateId)
                .from(securityKeyRegistryRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
