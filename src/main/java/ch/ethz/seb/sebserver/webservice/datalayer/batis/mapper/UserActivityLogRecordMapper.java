...
public interface UserActivityLogRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-12-12T11:08:43.196+01:00", comments="Source Table: user_activity_log")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-12-12T11:08:43.197+01:00", comments="Source Table: user_activity_log")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="user_uuid", javaType=String.class, jdbcType=JdbcType.VARCHAR),
