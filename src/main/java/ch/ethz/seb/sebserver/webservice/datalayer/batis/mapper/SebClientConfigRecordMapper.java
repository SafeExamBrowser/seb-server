...
public interface SebClientConfigRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-22T14:34:22.467+02:00", comments="Source Table: seb_client_configuration")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-22T14:34:22.468+02:00", comments="Source Table: seb_client_configuration")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="institution_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
