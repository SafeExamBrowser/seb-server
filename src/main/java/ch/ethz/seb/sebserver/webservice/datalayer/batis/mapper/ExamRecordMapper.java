...
public interface ExamRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-10-15T08:50:46.710+02:00", comments="Source Table: exam")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-10-15T08:50:46.711+02:00", comments="Source Table: exam")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="institution_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
