...
public interface ExamRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-06T15:56:14.077+02:00", comments="Source Table: exam")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-06T15:56:14.078+02:00", comments="Source Table: exam")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="institution_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
