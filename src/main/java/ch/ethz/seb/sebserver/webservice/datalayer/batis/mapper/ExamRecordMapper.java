...
public interface ExamRecordMapper {
    ...
    @ConstructorArgs({
        ...
        @Arg(column="followup_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
        @Arg(column="exclude_from_deletion", javaType=Integer.class, jdbcType=JdbcType.INTEGER)
    })
    ExamRecord selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2026-03-02T15:33:13.664+01:00", comments="Source Table: exam")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="institution_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
    ...
    default int insert(ExamRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(followupId).toProperty("followupId")
                .map(excludeFromDeletion).toProperty("excludeFromDeletion")
                .build()
    ...
    default int insertSelective(ExamRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(followupId).toPropertyWhenPresent("followupId", record::getFollowupId)
                .map(excludeFromDeletion).toPropertyWhenPresent("excludeFromDeletion", record::getExcludeFromDeletion)
                .build()
                .render(RenderingStrategy.MYBATIS3));
    }
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ExamRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, institutionId, lmsSetupId, externalId, owner, supporter, type, quitPassword, browserKeys, status, lmsSebRestriction, updating, lastupdate, active, examTemplateId, lastModified, quizName, quizStartTime, quizEndTime, lmsAvailable, followupId, excludeFromDeletion)
                .from(examRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2026-03-02T15:33:13.664+01:00", comments="Source Table: exam")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ExamRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, institutionId, lmsSetupId, externalId, owner, supporter, type, quitPassword, browserKeys, status, lmsSebRestriction, updating, lastupdate, active, examTemplateId, lastModified, quizName, quizStartTime, quizEndTime, lmsAvailable, followupId, excludeFromDeletion)
                .from(examRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2026-03-02T15:33:13.664+01:00", comments="Source Table: exam")
    default ExamRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, institutionId, lmsSetupId, externalId, owner, supporter, type, quitPassword, browserKeys, status, lmsSebRestriction, updating, lastupdate, active, examTemplateId, lastModified, quizName, quizStartTime, quizEndTime, lmsAvailable, followupId, excludeFromDeletion)
                .from(examRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(ExamRecord record) {
        return UpdateDSL.updateWithMapper(this::update, examRecord)
                ...
                .set(followupId).equalTo(record::getFollowupId)
                .set(excludeFromDeletion).equalTo(record::getExcludeFromDeletion);
    }
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(ExamRecord record) {
        return UpdateDSL.updateWithMapper(this::update, examRecord)
                ...
                .set(followupId).equalToWhenPresent(record::getFollowupId)
                .set(excludeFromDeletion).equalToWhenPresent(record::getExcludeFromDeletion);
    }
