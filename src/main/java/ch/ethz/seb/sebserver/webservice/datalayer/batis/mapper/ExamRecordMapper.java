...
public interface ExamRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-03-11T14:43:22.790+01:00", comments="Source Table: exam")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-03-11T14:43:22.791+01:00", comments="Source Table: exam")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="institution_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
