...
public class WebserviceURIService {
    ...
    public WebserviceURIService(
            @Value("${sebserver.gui.webservice.protocol:http}") final String webserviceProtocol,
            @Value("${sebserver.gui.webservice.address:localhost}") final String webserviceServerAddress,
            @Value("${sebserver.gui.webservice.port:8080}") final String webserviceServerPort,
            @Value("${sebserver.gui.http.webservice.contextPath:/}") final String contextPath,
            @Value("${sebserver.gui.webservice.apipath:/admin-api/v1}") final String webserviceAPIPath) {
