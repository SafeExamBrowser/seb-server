...
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.seb.examconfig.AttributeMapping;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.RestCallError;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.RestServiceImpl;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.batch.DoBatchAction;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.batch.GetBatchAction;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.batch.GetBatchActionPage;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.exam.*;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.exam.clientgroup.GetClientGroup;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.exam.clientgroup.GetClientGroupPage;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.exam.clientgroup.NewClientGroup;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.exam.clientgroup.SaveClientGroup;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.exam.indicator.*;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.exam.template.*;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.institution.ActivateInstitution;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.institution.GetInstitution;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.institution.GetInstitutionNames;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.institution.NewInstitution;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.lmssetup.*;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.logs.*;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.quiz.GetQuizData;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.quiz.GetQuizPage;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.quiz.ImportAsExam;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.seb.cert.*;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.seb.clientconfig.*;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.seb.examconfig.*;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.session.*;
import ch.ethz.seb.sebserver.webservice.integration.api.rest.api.useraccount.*;
...
public class UseCasesIntegrationTest extends GuiIntegrationTest {
    ...
    public void testUsecase07_CreateExamIndicator() {
        ...
        final Indicator indicatorToSave = new Indicator(
                ...
                Utils.immutableCollectionOf(
                        new Threshold(2000d, "000011", null),
                        new Threshold(5000d, "001111", null)));
    ...
    public void testUsecase09_CreateClientConfig() throws IOException {
        ...
        final Result<SEBClientConfig> newConfigResponse = restService
                ...
                .withFormParam(SEB_CLIENT_CONFIGURATION.ATTR_NAME, "No Password Protection")
        ...
        final Result<SEBClientConfig> configWithPasswordResponse = restService
                .getBuilder(NewClientConfig.class)
                .withFormParam(SEB_CLIENT_CONFIGURATION.ATTR_NAME, "With Password Protection")
                .withFormParam(SEBClientConfig.ATTR_CONFIG_PURPOSE, SEBClientConfig.ConfigPurpose.START_EXAM.name())
                .withFormParam(SEBClientConfig.ATTR_FALLBACK, Constants.TRUE_STRING)
                .withFormParam(SEBClientConfig.ATTR_FALLBACK_START_URL, "http://fallback.com/fallback")
                .withFormParam(SEBClientConfig.ATTR_FALLBACK_TIMEOUT, "100")
    ...
    public void testUsecase10_TestExamConfigBaseData() throws IOException {
        ...
        final AttributeMapping attributes = new AttributeMapping(
                0L,
                restService
                ...
                restService
                        ...
                        .withQueryParam(Orientation.FILTER_ATTR_TEMPLATE_ID, String.valueOf(0L))
                        .call()
                        .getOrThrow());
        
        assertNotNull(attributes);
        assertEquals(194, attributes.attributeIdMapping.size());
        assertEquals(
                "[active, audio, backToStart, browserSecurity, browserViewMode, exitSequence, functionKeys, kioskMode, logging, "
                        ...
                        + "zoom, zoomMode]",
                attributes.attributeGroupMapping.keySet()
                        .stream()
                        .sorted()
                        .toList()
                        .toString());

        final String viewIds = StringUtils.join(attributes.getViewIds().stream().map(String::valueOf)
...
//                        .get();
    ...
    public void testUsecase23_Certificates() throws Exception {
        ...
        final SEBClientConfig newConfig = restService
                .getBuilder(NewClientConfig.class)
                .withFormParam(SEB_CLIENT_CONFIGURATION.ATTR_NAME, "Connection Config with Cert")
...
//    }
    ...
    public void testUsecase29_TestBatchAction() throws IOException, InterruptedException {
        ...
        final Result<BatchAction> doBatchAction = restService
                ...
                .withFormParam(BATCH_ACTION.ATTR_ACTION_TYPE, BatchActionType.EXAM_CONFIG_STATE_CHANGE.name())
