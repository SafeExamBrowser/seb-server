...
CREATE TABLE IF NOT EXISTS `screen_proctoring_group` (
  ...
  `is_fallback` INT(1) UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS `client_connection` (
  ...
  `client_version_granted` TINYINT(1) UNSIGNED NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `exam_template` (
  ...
  `client_configuration_id` BIGINT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `feature_privilege` ;
